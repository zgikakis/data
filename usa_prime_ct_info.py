...
# 3) Once zip file generation has finished: returns status_url, filename, and download_url
# 4) Creates a pandas dataframe containing information from POST request
# 5) Downloads df to a specified filepath as a csv
...
# Create dictionary containing response data from usaspending API POST request
